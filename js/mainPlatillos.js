// const dominioMainPlatillos = "https://f3rn4nd021py.pythonanywhere.com";
const dominioMainPlatillos = "http://127.0.0.1:5000";
var categoria = 2;
...
window.addEventListener('load',(e)=>{
    ...
    confirmarEliminacionPlatillo.addEventListener('click',(e)=>{
        $.ajax({
            type: "PUT",
            url: dominioMainPlatillos + "/platillos/delete/" + id + "/",
            dataType: "json",
...
function platillosSelect(idCategoria) {
    $.ajax({
        type: "GET",
        url: `${dominioMainPlatillos}/platillos/selectCateg/${idCategoria}`,
        dataType: "json",
        success: function (data) {
            let contenido = '';
...
function platillosUpdate(){
    ...
    $.ajax({
        type: "PUT",
        url: `${dominioMainPlatillos}/platillos/update/${$('#txtIdPlatillo').val()}`,
...
function platillosInsert(){
    ...
    $.ajax({
        type: "POST",
        url: `${dominioMainPlatillos}/platillos/create/`,
        data: registrosPlatillo,
        dataType: 'json',
        contentType: false,
        enctype: 'multipart/form-data',
...
function platillosGet(id){
    ...
    $.ajax({
        type: "GET",
        url: `${dominioMainPlatillos}/platillos/get/${id}`,
        dataType: "json",
        success: function (data) {
